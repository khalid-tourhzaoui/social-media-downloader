        ...
        currentURL.includes("/instagram") && (
          ...
          >
            ...
            <div className="w-full md:w-1/3 hidden md:block">
              ...
              >
                <img
                  src="https://instagram.fhan15-1.fna.fbcdn.net/v/t51.2885-15/467034383_1390168331992254_7264123757914492964_n.jpg?stp=dst-jpg_e15&_nc_ht=instagram.fhan15-1.fna.fbcdn.net&_nc_cat=106&_nc_ohc=g9Q9_WynFYUQ7kNvgEC4VYN&_nc_gid=0d369c3bb9394a4f885fdd4b202b2b17&edm=APs17CUBAAAA&ccb=7-5&oh=00_AYAyHzOVdA6WzdAJRC6LXUg6_qcCTJ9fP11oyw0nl51JFg&oe=673D7A15&_nc_sid=10d13b"
                  alt={data.title}
                  className="w-2/3 sm:w-1/2 md:w-full mx-auto rounded-lg shadow-lg hover:shadow-primary2"
            ...
            <div className="flex flex-col justify-between w-full md:w-2/3 space-y-4">
              ...
              focus:outline-none focus:ring active:bg-indigo-600 active:text-white hover:scale-105 transition-all 
              duration-500 hover:shadow-shad hover:shadow-primary1`}
                    to={data.medias[0].url}
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label={`Download format ${data.medias[0].quality}`}
                  >
                    <FaDownload className="text-2xl" />
                  </Link>
                </motion.div>
